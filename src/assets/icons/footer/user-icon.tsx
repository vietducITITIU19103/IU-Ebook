        ...
        <>
            {
                isActive ?
                    <Box component="svg" xmlns="http://www.w3.org/2000/svg" width="21" height="26" viewBox="0 0 21 26" fill="none" {...other} sx={{ width: "20px", height: "26px", ...sx }}>
                        <path d="M10.3205 17.1963C4.92922 17.1963 0.324219 18.0463 0.324219 21.4463C0.324219 24.8475 4.90047 25.7275 10.3205 25.7275C15.7117 25.7275 20.3167 24.8788 20.3167 21.4775C20.3167 18.0763 15.7417 17.1963 10.3205 17.1963Z" fill={text.active} />
                        <path opacity="0.4" d="M10.3201 13.9575C13.9926 13.9575 16.9351 11.0138 16.9351 7.34254C16.9351 3.67129 13.9926 0.727539 10.3201 0.727539C6.64883 0.727539 3.70508 3.67129 3.70508 7.34254C3.70508 11.0138 6.64883 13.9575 10.3201 13.9575Z" fill={text.active} />
                    </Box>
                    :
