...
function LocationIcon({ color, ...other }: BoxProps & {color: string}) {
    const { palette } = useContext(ThemeContext)
    const colorCode = color ? color : palette.iub.text.footer 
    ...
    return (
        <Box component="svg" xmlns="http://www.w3.org/2000/svg" width="30" height="33" viewBox="0 0 17 21" fill="none" {...other} >
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M8.69873 19.5C7.50025 19.5 1.19922 14.3984 1.19922 9.06329C1.19922 4.88664 4.55632 1.5 8.69873 1.5C12.8411 1.5 16.1992 4.88664 16.1992 9.06329C16.1992 14.3984 9.89721 19.5 8.69873 19.5Z" stroke={colorCode} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </Box>
    );
}
