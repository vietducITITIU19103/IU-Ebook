...
function CartIcon({ ...other }: BoxProps) {
    return (
        <Box component="svg" xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 23 22" fill="none" { ...other }>
            ...
            <path d="M7.53125 12.2834H10.5666" stroke="#4E49D6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </Box>
    )
}
