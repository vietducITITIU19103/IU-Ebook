...
function HomeIcon({ isActive, sx, ...other }: Props) {
    ...
    return (
        <Box component="svg" xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16" fill={isActive ? "#4E49D6" : "transparent"} {...other} sx={{ width: "14px", height: "16px", ...sx }}>
